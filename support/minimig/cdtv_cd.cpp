...
// 9..11 are track-relative position. Returns 13. Defender of the Crown's
// title-music loop polls this every few frames during play and after
// PLAY_COMPLETE to know when to re-arm the cue and to advance its
