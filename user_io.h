...
#define UIO_MOUSE2      0x07  // minimig: second mouse (controller port 2) - dual-mouse
...
void user_io_mouse2(unsigned char b, int16_t x, int16_t y, int16_t w); // port 2 (dual-mouse)
